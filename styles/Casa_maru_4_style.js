...
var style_Casa_maru_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var labelFont = "26.0px \'MS Reference Sans Serif\', sans-serif";
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 14.8 + size, points: 4,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(50,87,128,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(61,126,201,1.0)'})}),
